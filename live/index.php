...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-3 text-center bg-success rounded">
                <h1 class="text-white m-0 mt-2">MERON</h1>
                <p class="text-white m-0 mb-2"><span id="meron-main-bet" >0</span><br><span id="meron-per100">0</span></p>
            </div>
            <div class="col-4 border border-info rounded m-1 p-0 bg-white">
                <div class="form-group">
                    <textarea class="form-control p-1 border-0 text-center" id="description" style="font-size:18px;"></textarea>
                </div>
            </div>
            <div class="col-3 text-center bg-danger rounded">
                <h1 class="text-white m-0 mt-2">WALA</h1>
                <p class="text-white m-0 mb-2"><span id="wala-main-bet" >0</span><br><span id="wala-per100">0</span></p>
            </div>
            <div class="col-1"></div>
        </div>
    </div>
