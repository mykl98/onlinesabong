...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
        <div class="row">
            <div class="col text-center bg-success rounded">
                <h1 class="text-white m-0 mt-2">MERON</h1>
                <p class="text-white m-0 mb-2"><span id="meron-main-bet" >0</span> - <span id="meron-per100">0</span></p>
                <div class="form-group">
                    <textarea class="form-control p-1 border-0 bg-success text-white" id="description"></textarea>
                </div>
            </div>
        </div>
    </div>
